...
public sealed partial class ConcurrentPriorityQueue<TElement, TPriority>
{
    ...
    /// <remarks>
    /// <para>
    /// <b>Snapshot semantics.</b> The count is the sum of the lock-striped per-sub-queue volatile
    ...
    /// <remarks>
    /// <para>
    /// <b>Snapshot semantics.</b> Emptiness is decided by scanning the lock-striped per-sub-queue
